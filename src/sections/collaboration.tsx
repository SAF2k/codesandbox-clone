            ...
            <motion.div style={{ scale, x, y }} className="origin-top">
              ...
              >
                <motion.img
                  ...
                  className="h-[1.5vw] w-[1.5vw] rounded-full border border-green-500 object-cover"
                ...
                <motion.img
                  ...
                  className="h-[1.5vw] w-[1.5vw] rounded-full border border-yellow-500 object-cover"
                  src="https://unsplash.com/photos/sibVwORYqs0/download?force=true&w=128&h=128"
                />
                <motion.img
                  style={{ scale: avatarThreeScale }}
                  className="h-[1.5vw] w-[1.5vw] rounded-full border border-purple-600 object-cover"
