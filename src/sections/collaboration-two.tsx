...
export default function CollaborationTwo () {
  ...
  return (
    <section ref={targetRef}>
      <div className="relative h-[800vh] overflow-clip">
        <div className="sticky top-1/2 flex origin-center -translate-y-1/2 justify-center">
          ...
          >
            <Image width={1920} height={1080} alt="image" src="/main-screen.svg" className="h-auto w-full" />
            <motion.img
          ...
          >
            <Image width={1920} height={1080} alt="image" src="/loading-screen.svg" className="h-auto w-full" />
            <motion.div
              style={{ opacity: newBranchOpacity }}
        ...
        <motion.p
          ...
          className="translate-y-centered-offset top-1/2 left-[20px] w-[400px] ml-52 pl-16 text-3xl leading-tight text-white"
        >
          Not only share code,
          <br />
        ...
        <motion.p
          ...
          className="translate-y-centered-offset top-1/2 right-[20px] w-[400px] mr-64 pr-16 text-2xl leading-tight text-white"
        >
